...
export async function getTrendingMovies() {
  ...
  const heroOverview = hero.shadowRoot.querySelector('.hero-info__synopsis');
  heroOverview.innerHTML = moviesSorted[0].overview;
  const heroDetailsBtn = hero.shadowRoot.querySelector('.hero-info__movie-btn');
